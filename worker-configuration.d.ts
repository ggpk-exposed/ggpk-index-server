/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4c57717a99dc6cec0d3ac297ca9d2fb4)
// Runtime types generated with workerd@1.20260521.1 2025-10-08 nodejs_compat
interface __BaseEnv_Env {
	BROWSER: "https://www.ggpk.exposed";
	INDEX_CONTAINER: DurableObjectNamespace<import("./worker/index").IndexContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "IndexContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BROWSER">> {}
}
